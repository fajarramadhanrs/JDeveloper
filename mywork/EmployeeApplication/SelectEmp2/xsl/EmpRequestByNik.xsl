...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      ...
      <rootElement name="InputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/sp/DBEmpByNik"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.9.0(build 180326.0917) AT [WED MAY 23 14:21:07 ICT 2018]. -->
?>
