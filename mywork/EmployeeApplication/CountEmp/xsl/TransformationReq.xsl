...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      ...
      <rootElement name="InputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/sp/DBCountRow"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.9.0(build 180326.0917) AT [FRI MAY 25 16:08:23 ICT 2018]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <db:InputParameters>
      <db:ROWCOUNT>
        <xsl:value-of select="/tns:emplRequest/tns:count"/>
      </db:ROWCOUNT>
    </db:InputParameters>
  </xsl:template>
</xsl:stylesheet>
